...
Page({
  ...
  toGooodsinfo(e){
    wx.navigateTo({
      url: '/baoA/pages/goodsGuanli/putongGoods/putongGoods?type=2' + '&goodsid=' + e.currentTarget.dataset.goodsid
    })
},
changesL(e) {
  ...
  toFabu() {
    ...
    wx.navigateTo({
      url: '/baoA/pages/goodsFabu/xianshiFabu/xianshiFabu'
    })
    wx.hideLoading()
  },
  //获取商品属性分类
  getshuxingType() {
    ...
    wx.request({
      ...
      data: {
        ...
        type: 4, //商品活动类型 0-普通零售（含积分换购） 1-零售团购 3-零售满减 4-零售限时 5-厂家直销//传输type表示展示对应商品类型不为空的商品分类列表
  ...
  getgoodsListdata() {
    ...
    wx.request({
      ...
      data: {
        ...
        type: 4, //商品种类标签 0普通零售商品 1零售团购商品 3零售满减商品 4零售限时商品 5零售商品发起拼团
