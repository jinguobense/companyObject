...
Page({
  ...
  toGooodsinfo(e) {
    wx.navigateTo({
      url: '/baoA/pages/goodsGuanli/putongGoods/putongGoods?type=1' + '&goodsid=' + e.currentTarget.dataset.goodsid
    })
  },
  changesL(e) {
  ...
  toFabu() {
    ...
    wx.navigateTo({
      url: '/baoA/pages/goodsFabu/tuanpingFabu/tuanpingFabu'
    })
    wx.hideLoading()
  },
  //点击进入图库
  ...
  getgoodsListdata() {
    ...
    wx.request({
      ...
      data: {
        ...
        type: 1, //商品种类标签 0普通零售商品 1零售团购商品 3零售满减商品 4零售限时商品 5零售商品发起拼团
